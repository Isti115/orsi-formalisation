module Prototype_4.example

import Prototype_4.Simple as PSi
import Prototype_4.Statements as PSt
...
-- cwptest : PSt.Implies (Prototype_4.example.pred2) (PSi.CWP (Prototype_4.example.cptest2, Prototype_4.example.pred3))
-- cwptest =
--   PSt.Impl prf
--     where
--       prf s p =
...
cwptest2 :
  PSt.Implies
    (PSi.CWP (Prototype_4.example.cptest2, Prototype_4.example.pred2))
    (PSi.CWP (Prototype_4.example.cptest2, Prototype_4.example.pred3))
cwptest2 =
  PSt.Impl prf
    where
...
cwptest3 :
  PSt.Implies
    (PSi.CWP (Prototype_4.example.cptest3, Prototype_4.example.pred2))
    (PSi.CWP (Prototype_4.example.cptest3, Prototype_4.example.pred3))
cwptest3 =
  PSt.Impl prf
    where
...
-- test4 : PSi.Implies (Prototype_4.example.pred2) (PSi.WP (Prototype_4.example.inst4, Prototype_4.example.pred3))
-- test4 =
--   PSi.Impl pred2 (PSi.WP (inst4, pred3)) prf
--     where
--       prf :
--         (s : State) ->
--         (pws Prototype_4.example.pred2 s) ->
--         (pws (PSi.WP (Prototype_4.example.inst4, Prototype_4.example.pred3)) s)
--       prf s p =
--         let
--           q =
--             LTESucc $
