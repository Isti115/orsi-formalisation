-- 2019-04-16 // after consulting with Ambrus and ??? (Nikolai) in Eker :D
...
logEqIsTrueTo {b = False} p = void p
...
logEqTo' {n = Z} {m = Z} p impossible
logEqTo' {n = Z} {m = (S k)} p = Refl
logEqTo' {n = (S k)} {m = Z} p impossible
logEqTo' {n = (S k)} {m = (S j)} p = logEqTo' p
...
logEqFrom' {n = (S k)} {m = Z} p = absurd p
logEqFrom' {n = (S k)} {m = (S j)} p = logEqFrom' p
